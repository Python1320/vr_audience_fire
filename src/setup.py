...
setup(
    ...
    executables=[Executable("main.py", target_name="vr_audience_fire.exe", base=False), Executable("main.py", target_name="vr_audience_fire_NoConsole.exe", base="Win32GUI")],
)